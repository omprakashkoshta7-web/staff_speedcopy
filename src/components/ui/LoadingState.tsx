...
import { STAFF_COLORS } from "../../utils/colors";
  ...
  return (
    <div className="flex min-h-[400px] items-center justify-center">
      <div className="text-center">
        ...
        <div className="relative mx-auto mb-6 h-20 w-64">
          ...
          <div className="absolute left-0 top-1/2 -translate-y-1/2 animate-pulse">
            <div 
              ...
              style={{ 
                background: `linear-gradient(135deg, ${STAFF_COLORS.primary} 0%, ${STAFF_COLORS.primaryLight} 100%)` 
              }}
            >
          ...
          <div 
            ...
            style={{ borderColor: STAFF_COLORS.gray300 }}
          ></div>
          ...
          <div className="absolute left-14 top-1/2 -translate-y-1/2 animate-[movePackage_2s_ease-in-out_infinite]">
            <div 
              ...
              style={{ backgroundColor: STAFF_COLORS.accent }}
            >
          ...
          <div className="absolute right-0 top-1/2 -translate-y-1/2">
            <div 
              className="rounded-xl p-2.5 shadow-lg"
              style={{ 
                background: `linear-gradient(135deg, ${STAFF_COLORS.success} 0%, ${STAFF_COLORS.successLight} 100%)` 
              }}
            >
        ...
        {/* Loading text */}
        <p className="text-base font-bold" style={{ color: STAFF_COLORS.gray800 }}>
          {message}<span className="loading-dots"></span>
        </p>
        <p className="mt-1 text-xl font-black" style={{ color: STAFF_COLORS.primary }}>SpeedCopy</p>
        <p className="mt-0.5 text-xs" style={{ color: STAFF_COLORS.gray500 }}>Fast Printing & Delivery Service</p>
      </div>
    </div>
  );
}
